...
{
    /// <inheritdoc />
    public partial class FixedEntityVenues : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConcertEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConcertEntries_Concert_ConcertId",
                        column: x => x.ConcertId,
                        principalTable: "Concert",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConcertEntries_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConcertEntries_ConcertId",
                table: "ConcertEntries",
                column: "ConcertId");

            migrationBuilder.CreateIndex(
                name: "IX_ConcertEntries_UserId",
                table: "ConcertEntries",
                column: "UserId");
