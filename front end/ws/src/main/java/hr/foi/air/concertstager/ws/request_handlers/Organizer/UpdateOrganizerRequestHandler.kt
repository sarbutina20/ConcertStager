...
class UpdateOrganizerRequestHandler (private val jwt: String, private val id: Int, private val body: OrganizerUpdateBody)
    ...
    override fun getServiceCall(): Call<SuccessfulResponseBody<Organizer>> {
        ...
        return service.updateOrganizer(jwt, id, body)
    }
}