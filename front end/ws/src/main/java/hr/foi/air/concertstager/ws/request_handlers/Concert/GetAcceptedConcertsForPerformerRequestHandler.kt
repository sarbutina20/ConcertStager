...
class GetAcceptedConcertsForPerformerRequestHandler(private val jwt: String, private val id: Int) : TemplateRequestHandler<Concert>() {
    override fun getServiceCall(): Call<SuccessfulResponseBody<Concert>> {
        val service = NetworkService.concertService
        return service.getAcceptedConcertsForPerformer(jwt, id)
    }
}