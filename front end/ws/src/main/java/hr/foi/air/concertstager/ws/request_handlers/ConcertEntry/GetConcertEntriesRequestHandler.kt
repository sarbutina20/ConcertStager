...
class GetConcertEntriesRequestHandler(private val jwt: String, private val id: Int): TemplateRequestHandler<ConcertEntry>() {
    override fun getServiceCall(): Call<SuccessfulResponseBody<ConcertEntry>> {
        val service = NetworkService.concertService
        return service.getConcertEntries(jwt, id)
    }
}